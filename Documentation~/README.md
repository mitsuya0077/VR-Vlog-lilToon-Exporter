...
- 0.10.1はschema 2.0の専用データを生成します。表示には対応版のVR Vlogが必要です。160MiBを超えるファイルには、160MiB制限の解除に対応したVR Vlogが必要です。先行配布するTestFlightの更新内容を確認してください。全機能のiPhone実機比較はまだ完了していません。
